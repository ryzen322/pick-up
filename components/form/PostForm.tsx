                ...
                <FormItem className=" space-y-0">
                  ...
                  <FormControl>
                    <Input
                      ...
                      {...field}
                      className=" h-6 px-0 focus-visible:ring-transparent outline-none focus-visible:ring-white placeholder:text-xs"
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
                ...
                <FormItem className=" mt-2">
                  ...
                  <FormControl>
                    <Textarea
                      ...
                      className="resize-none focus-visible:ring-transparent placeholder:text-xs"
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
